# This Makefile is for the FTDId2xx extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/FTDId2xx.pm]
#     AUTHOR => q[Matthias Voelker <m.matze@gmx.de>]
#     DEFINE => q[]
#     INC => q[-I. -I/usr/local/include -I..]
#     LIBS => [q[-lftd2xx]]
#     NAME => q[FTDId2xx]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/FTDId2xx.pm]
...
INSTALLARCHLIB = /usr/lib/perl5/5.8.5/i386-linux-thread-multi
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = /usr/lib/perl5/site_perl/5.8.5/i386-linux-thread-multi
DESTINSTALLSITEARCH = $(DESTDIR)$(INSTALLSITEARCH)
INSTALLVENDORARCH = /usr/lib/perl5/vendor_perl/5.8.5/i386-linux-thread-multi
...
MAKEMAKER   = /home/vkr/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.42
MM_REVISION = 41145
...
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = lib/FTDId2xx.pm
INC = -I. -I/usr/local/include -I..
DEFINE = 
...
XS_FILES = FTDId2xx.xs
C_FILES  = FTDId2xx.c
O_FILES  = FTDId2xx.o
H_FILES  = WinTypes.h \
	ppport.h
MAN1PODS = 
MAN3PODS = lib/FTDId2xx.pm
...
TO_INST_PM = SmallTest.pl \
	lib/FTDId2xx.pm

PM_TO_BLIB = lib/FTDId2xx.pm \
	blib/lib/FTDId2xx.pm \
	SmallTest.pl \
	$(INST_LIB)/SmallTest.pl
...
# FTDId2xx might depend on some other libraries:
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/FTDId2xx.pm $(INST_MAN3DIR)/FTDId2xx.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) pm_to_blib \
	  FTDId2xx.c $(INST_ARCHAUTODIR)/extralibs.ld \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                FTDId2xx' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            Perl extension for interface to FTDI d2xx library (tested with version 0.4.16 linux) ' >> META_new.yml
	$(NOECHO) $(ECHO) 'license:             ~' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:              ' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Matthias Voelker <m.matze@gmx.de>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for interface to FTDI d2xx library (tested with version 0.4.16 linux) </ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Matthias Voelker &lt;m.matze@gmx.de&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/FTDId2xx.pm blib/lib/FTDId2xx.pm \
	  SmallTest.pl $(INST_LIB)/SmallTest.pl 
